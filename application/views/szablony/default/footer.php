    <div id="STOPKA">
        <div id="STOPKA_LOGO">
            ...
            <p><strong>Polska Piłka</strong><br />Ł. Iżuk &amp;&amp; T. Cekała</p>
        </div>
        <div id="STOPKA_PRAWA">
            <strong>Copyright </strong>2011 &copy; Polska Piłka<br />
            All Rights Reserved. Privacy Police. Terms of Use.
        </div>
        <div id="STOPKA_RIGHT">
            <br /><p><a href="http://jigsaw.w3.org/css-validator/check/referer">
                <img style="border:0;width:68px;height:20px"
