             ...
             <div id="TRESC">
                 ...
                 <?php $czyAdmin = $this->session->userdata('uprawnienie');
                    ...
                    echo form_fieldset(lang('news_fieldset_addnews'), array('class' => 'form_dodawania_uzytk_fieldset'));
                    //echo '<p>';
                    ...
                    echo '<br /><br />';
                    echo form_submit('dodaj', lang('news_addnews_addbutton'));
                ...
                <div class="news_kontener">
                    ...
                    <div class="news_caly">
                        ...
                        <div class="news_tresc">
                            ...
                            <br style="line-height:5px;" /><?php echo anchor(site_url().'/main/wpis/'.$wpis['idWpisu'], lang('news_readmore'), array('class'=>'read_more')) ?>
                        </div>
             ...
             <?php if($wpisy2 != null){ ?>
                ...
                <div class="newsy_pozostale_kontener">
                    ...
                    <?php endforeach ?>
                    <br style="line-height:5px;" /><a href="#" class="read_more"><?php echo lang('news_allnews'); ?></a>
                </div>
              <?php } ?>
            </div>
        <!--</div>
